...
var LeftSidebar = function() {
    ...
    return _createClass(t, [{
        ...
        value: function() {
            ...
            $("#two-col-sidenav-main").length && (n = $("#two-col-sidenav-main .nav-link"),
    ...
    return _createClass(t, [{
        ...
        value: function() {
            ...
            $(".navbar-nav a").each(function() {
                ...
                $(this).parent().parent().parent().parent().hasClass("mega-dropdown-menu") ? ($(this).parent().parent().parent().parent().parent().addClass("active"),
                $(this).parent().parent().parent().parent().parent().parent().addClass("active")) : (t = $(this).parent().parent()[0].querySelector(".dropdown-item")) && (e = window.location.href.split(/[?#]/)[0],
                t.href != e && !t.classList.contains("dropdown-toggle") || t.classList.add("active")),
            ...
            e.forEach(function(n) {
                n.addEventListener("click", function(t) {
                    var e;
                    n.parentElement.classList.contains("nav-item") || (a = !0,
    ...
    return _createClass(t, [{
        ...
        value: function() {
            $(document).on("click", "body", function(t) {
                ...
                0 < $(t.target).closest(".right-bar-toggle, .right-bar").length || 0 < $(t.target).closest(".left-side-menu, .side-nav").length || $(t.target).hasClass("button-menu-mobile") || 0 < $(t.target).closest(".button-menu-mobile").length || ($("body").removeClass("right-bar-enabled"),
  ...
  , ThemeCustomizer = function() {
    ...
    return _createClass(t, [{
        ...
        value: function(t) {
            (this.config.sidebar.user = t) ? this.body.setAttribute("data-sidebar-user", t) : this.body.removeAttribute("data-sidebar-user"),
            this.setSwitchFromConfig()
        }
    }, {
        key: "resetTheme",
        ...
        value: function() {
            ...
            l && (t = document.querySelector("input[type=checkbox][name=leftbar-color][value=" + l.leftbar.color + "]"),
...
function(n) {
    ...
    t.prototype.init = function() {
        ...
        t && document.getElementById("selectToastPlacement").addEventListener("change", function() {
            t.dataset.originalClass || (t.dataset.originalClass = t.className),
            t.className = t.dataset.originalClass + " " + this.value
        });
        ...
        e && e.addEventListener("click", function() {
            ...
            e = "primary",
            (n = document.createElement("div")).innerHTML = '<div class="alert alert-' + e + ' alert-dismissible" role="alert">' + t + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>',
            a.append(n)
        }),
